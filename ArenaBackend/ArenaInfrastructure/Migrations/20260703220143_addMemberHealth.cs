...
{
    /// <inheritdoc />
    public partial class addMemberHealth : Migration
    {
        /// <inheritdoc />
        ...
        {
            migrationBuilder.Sql("IF OBJECT_ID('dbo.MemberHealthVectors', 'U') IS NOT NULL DROP TABLE dbo.MemberHealthVectors;");
        }
    }
}
